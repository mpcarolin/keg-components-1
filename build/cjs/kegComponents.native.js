...
var validateFunctions = function validateFunctions(functionObj) {
  return jsutils.mapEntries(functionObj, function (name, func) {
...
var Progress = function Progress(props) {
  ...
  }, isValidComponent(LoadingIndicator) ? React__default.createElement(LoadingIndicator, null) : text && React__default.createElement(Text, {
...
var buildStyles$1 = function buildStyles(style, styles, theme, type) {
  var defStyle = theme.get(jsutils.checkCall(jsutils.get(theme, 'transition.opacity')), "components.image.".concat(type));
...
var Element$1 = React__default.forwardRef(function (_ref, ref) {
  ...
  return React__default.createElement(reactNative.Image, _extends({}, attrs, props, {
    ref: ref
  }));
});
...
var CardImage = function CardImage(_ref2) {
  var image = _ref2.image,
      ...
      title = _ref2.title;
  var theme = reTheme.useTheme();
  return React__default.createElement(Image, _extends({}, image, {
    styles: {
      loading: styles.loading,
      wrapper: styles.wrapper
    },
    style: theme.join(jsutils.get(theme, ['components', 'card', 'image', 'image']), styles.image)
  }), (title || subtitle) && React__default.createElement(CardImageTitle, {
    subtitle: subtitle,
    title: title,
    styles: styles,
    theme: theme
...
var CardHeader = function CardHeader(_ref) {
  var header = _ref.header,
      ...
      styles = _ref.styles;
  if (!header || React__default.isValidElement(header)) return header || null;
  return React__default.createElement(View, null, React__default.createElement(Text, {
    numberOfLines: numberOfLines,
    style: styles.header
  }, header), React__default.createElement(Divider, {
...
var CardFooter = function CardFooter(_ref3) {
  var footer = _ref3.footer,
      ...
      styles = _ref3.styles;
  if (!footer || React__default.isValidElement(footer)) return footer || null;
  return React__default.createElement(View, null, React__default.createElement(Divider, {
    style: styles.divider
...
var getImgProps = function getImgProps(image, styles) {
  return jsutils.isStr(image) ? {
    src: image,
    style: styles.image
  } : _objectSpread2({}, image, {
    style: _objectSpread2({}, jsutils.deepMerge(image.style, styles.image))
  });
};
var Card = function Card(_ref) {
  ...
  return React__default.createElement(CardContainer, {
    ...
    styles: cardStyles
  }), hasImage && React__default.createElement(CardImage, {
    title: title,
    subtitle: subtitle,
    image: imgProps,
    children: children,
  ...
  }, children), footer && React__default.createElement(CardFooter, {
    footer: footer,
    theme: theme,
...
var Checkbox = reTheme.withTheme(function (props) {
  ...
  var checkboxStyle = theme.join(jsutils.get(theme, ['form', 'checkbox']), style);
...
var NativeInput = React.forwardRef(function (_ref, ref) {
  var elProps = _ref.elProps,
...
var TouchableNativeInput = withTouch(NativeInput, {
  showFeedback: false
});
...
var Slt = React__default.forwardRef(function (_ref, ref) {
  var elProps = _ref.elProps,
      children = _ref.children,
...
var buildStyles$4 = function buildStyles(styles, theme, checked, type) {
...
var SideText = function SideText(_ref) {
  var text = _ref.text,
      style = _ref.style;
  return isValidComponent(text) ? text : jsutils.isStr(text) && React__default.createElement(Text, {
    style: style
  }, text);
};
var SwitchWrapper = function SwitchWrapper(props) {
  ...
  var builtStyles = buildStyles$4(styles, theme, isChecked, type || 'switch');
  return React__default.createElement(View, {
    style: builtStyles.container
  }, React__default.createElement(SideText, {
    text: leftText,
...
var Element$3 = React__default.forwardRef(function (_ref, ref) {
  var elProps = _ref.elProps,
      children = _ref.children,
      props = _objectWithoutProperties(_ref, ["elProps", "children"]);
  return React__default.createElement(reactNative.Switch, _extends({}, elProps, props, {
    ref: ref
  }), children);
});
...
var Column = reTheme.withTheme(function (_ref) {
  var children = _ref.children,
      size = _ref.size,
      center = _ref.center,
      theme = _ref.theme,
  ...
  return React__default.createElement(Container, _extends({}, props, {
    size: size,
    flexDir: "column",
    style: theme.join(jsutils.get(theme, ['layout', 'grid', 'column']), props.style, {
...
var height = jsutils.get(defaults, 'form.switch.height', 20);
var width = jsutils.get(defaults, 'form.switch.width', 20);
var sharedToggle = {
  container: {
    width: '100%',
    display: 'flex'
...
var height$1 = jsutils.get(defaults, 'form.checkbox.height', 20);
var width$1 = jsutils.get(defaults, 'form.checkbox.width', 20);
var checkbox = _objectSpread2({
  ...
  indicator: {
    ...
    $web: {
      ...
      backgroundColor: jsutils.get(colors$1, 'palette.gray02'),
      borderRadius: jsutils.get(defaults, 'form.border.radius', 5)
    }
  },
  on: {
    $web: {
      backgroundColor: jsutils.get(colors$1, 'palette.green02')
    }
  },
  disabled: {
    $all: {
...
var input = {
  default: {
    ...
    $web: _objectSpread2({
      border: "1px solid ".concat(jsutils.get(colors$1, 'palette.white03')),
      borderBottom: "1px solid ".concat(jsutils.get(colors$1, 'palette.gray03')),
...
var space$2 = jsutils.get(defaults, 'form.checkbox.space', 15);
var height$2 = jsutils.get(defaults, 'form.switch.height', 20);
var width$2 = jsutils.get(defaults, 'form.switch.width', 20);
var switchStyles = _objectSpread2({
  ...
  on: {
    $web: {
      left: width$2,
      backgroundColor: jsutils.get(colors$1, 'surface.primary.dark'),
