...
var Progress = function Progress(props) {
  ...
  }, isValidComponent(LoadingIndicator) ? React__default.createElement(LoadingIndicator, null) : text && React__default.createElement(Text$1, {
...
var CardImageTitle = function CardImageTitle(_ref) {
  ...
  }, title && React__default.createElement(Text$1, {
    style: theme.join(jsutils.get(theme, ['components', 'card', 'featured', 'title']), styles.title)
  }, title), subtitle && React__default.createElement(Text$1, {
...
var CardHeader = function CardHeader(_ref) {
  ...
  return React__default.createElement(View, null, React__default.createElement(Text$1, {
...
var SideText = function SideText(_ref) {
  var text = _ref.text,
      style = _ref.style;
  return isValidComponent(text) ? text : jsutils.isStr(text) && React__default.createElement(Text$1, {
    style: style
  }, text);
};
...
var WebInput = React__default.forwardRef(function (_ref, ref) {
  var elProps = _ref.elProps,
